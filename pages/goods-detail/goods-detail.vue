<template>
	<view class="goods_detail">
		...
		<view class="box1">
			<view class="price">
				<text>￥ {{content.sell_price}}</text>
				<text>￥ {{content.market_price}}</text>
			</view>
			<view class="goods_name">{{content.title}}</view>
		</view>
		<view class="line"></view>
		<view class="box2">
			<view>货号：{{content.goods_no}}</view>
			<view>库存：{{content.stock_quantity}}</view>
		</view>
		<view class="line"></view>
		<view class="box3">
